...
function calcularResultado() {
    ...
    if (puntaje <= 15) {
        ...
        textoFin = `<p><b>Aunque ya estás en un gran camino, siempre hay margen para mejorar y optimizar. <br>Te invitamos a unirte a nuestro Curso de Educación Financiera para:</b></p>
        <ul>
            <li>Refinar tus estrategias de inversión: Aprende sobre nuevas oportunidades y herramientas para maximizar tus rendimientos.</li>
            <li>Evaluación y ajuste de objetivos: Mantén tus metas financieras actualizadas y ajusta tu plan según tus necesidades.</li>
        </ul>
        `;
        sugerencias = [{
                title: 'Gestión eficiente del ahorro',
                content: 'Has logrado establecer un ahorro constante y tienes un fondo de emergencia..'
            },
            {
                title: 'Presupuesto bien definido',
                content: 'Mantienes un presupuesto equilibrado que te permite alcanzar tus metas financieras..'
            },
            {
                title: 'Manejo adecuado de deudas',
                content: 'Tus deudas están bajo control y utilizas el crédito de manera responsable.'
            }
        ];
    } else if (puntaje <= 25) {
        ...
        `;
        sugerencias = [{
                title: 'Ahorro irregular',
                content: 'Aunque tienes la intención de ahorrar, no siempre lo logras de manera constante.'
            },
            {
                title: 'Presupuesto flexible',
                content: 'Mantienes un presupuesto, pero a veces es difícil seguirlo al pie de la letra.'
            },
            {
                title: 'Deudas manejables',
                content: 'Tienes algunas deudas bajo control, pero podrías beneficiarte de estrategias adicionales para reducirlas más rápidamente.'
            }
        ];
    } else {
        ...
        textoFin = `<p><b>No te preocupes, estamos aquí para ayudarte a mejorar y tomar el control de tus finanzas. <br>Te invitamos a unirte a nuestro Curso de Educación Financiera, donde aprenderás a:</b></p>
        <ul>
            <li>Iniciar y mantener un hábito de ahorro: Implementa estrategias prácticas para empezar a ahorrar de inmediato.</li>
            <li>Crear y seguir un presupuesto efectivo: Establece un presupuesto que te permita gestionar tus gastos y aumentar tus ahorros.</li>
            <li>Reducir y manejar tus deudas: Conoce técnicas para reducir tus deudas y evitar que crezcan.</li>
        </ul>
        `;
        sugerencias = [{
                title: 'Falta de ahorro',
                content: 'No has logrado establecer un fondo de emergencia o ahorrar de manera regular.'
            },
            {
                title: 'Presupuesto inexistente o ineficaz',
                content: 'No tienes un presupuesto definido, lo que dificulta la gestión de tus finanzas.'
            },
            {
                title: 'Deudas crecientes',
                content: 'Tienes deudas considerables que no estás manejando de una forma óptima.'
            },
        ];
    }
    ...
    sugerenciasContainer.innerHTML += `<p>${textoFin}</p><br><br><br>`;
